...
def get_arguments():
    ...
    parser.add_argument(
        ...
        nargs=2,
        type=float,
        help="adam betas (default: 0.5 0.9)",
    )
    parser.add_argument("--weight-decay", default=1e-4, type=float, help="")
    parser.add_argument(
        "--step-size", default=3, type=int, help="scheduler step size (default: 8)"
    )
    parser.add_argument(
        "--gamma", default=0.1, type=float, help="scheduler gamma (default: 0.5)"
    )
    parser.add_argument(
        "--seed", default=-1, type=int, help="random seed (default: random)"
    )
    parser.add_argument(
        "--print-every", default=50, type=int, help="print-every (default: 1)"
    )
    parser.add_argument(
        "--save-every", default=1, type=int, help="print-every (default: 1)"
    )
    parser.add_argument(
